package com.lucasartur.course.config;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null, "SmartTV","Nulla eu imperdiet purus. maecenas ante", 2190.0,"");
